...
namespace Finate.Persistence.Migrations
{
    ...
    [Migration("20240322180901_JobFormTableCreate_CreateManyToMany")]
    partial class JobFormTableCreate_CreateManyToMany
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Finate.Domain.Entities.CandidateFormExtension", b =>
                {
                    b.HasOne("Finate.Domain.Entities.Form", "Form")
                        .WithMany()
            ...
            modelBuilder.Entity("Finate.Domain.Entities.JobFormDescriptionPart", b =>
                {
                    b.HasOne("Finate.Domain.Entities.JobFormExtension", "JobFormExtension")
                        .WithMany("DescriptionParts")
                        .HasForeignKey("JobFormId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("JobFormExtension");
                });
